...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSInteger indexOfPosition = [self.dbManager.arrColumnNames indexOfObject:@"position"];
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"Age: %@ | Position: %@", [[self.arrPeopleInfo objectAtIndex:indexPath.row] objectAtIndex:indexOfAge], [[self.arrPeopleInfo objectAtIndex:indexPath.row] objectAtIndex:indexOfPosition]];
